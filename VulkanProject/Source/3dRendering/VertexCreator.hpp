...
void addBlockMeshData(int x, int y, int z, int vertexX, int vertexY, int vertexZ, std::vector<Vertex>& vertices, std::vector<uint32_t>& indices, BlockType blockType,
